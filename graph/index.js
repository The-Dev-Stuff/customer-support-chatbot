...
/*
  ...
  However, if the state.nextRepresentative is conversational, just transition to "__end__".
 */
...
// Here we add an edge to the "technical_support" would always transition to "__end__".
